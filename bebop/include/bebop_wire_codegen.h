...
BEBOP_API Bebop_WireResult Bebop_Reader_Init(
    Bebop_Reader* rd, Bebop_WireCtx* ctx, const uint8_t* buf, size_t len
);
BEBOP_API Bebop_WireResult Bebop_Reader_GetMessageIndex(Bebop_Reader* rd, Bebop_MessageIndex* out);
BEBOP_API Bebop_WireResult Bebop_Reader_BeginMessageIndex(
    Bebop_Reader* rd, Bebop_MessageIndex* out
);
BEBOP_API Bebop_WireResult Bebop_MessageIndex_Init(Bebop_MessageIndex* out, Bebop_View encoded);
BEBOP_API Bebop_WireResult Bebop_MessageIndex_Begin(Bebop_MessageIndex* out, Bebop_View encoded);
BEBOP_API Bebop_WireResult Bebop_MessageIndex_Validate(const Bebop_MessageIndex* index);
BEBOP_API Bebop_WireResult Bebop_MessageIndex_Field(
    const Bebop_MessageIndex* index, uint8_t tag, Bebop_View* field, bool* present
);
BEBOP_API Bebop_WireResult Bebop_MessageIndex_FieldAt(
    const Bebop_MessageIndex* index, uint8_t rank, Bebop_View* field
);
BEBOP_API Bebop_WireResult Bebop_MessageIndex_BlockMasks(
    const Bebop_MessageIndex* index, uint32_t masks[8]
);
BEBOP_API void Bebop_MessageFieldIterator_Init(
    Bebop_MessageFieldIterator* iterator, const Bebop_MessageIndex* index
);
BEBOP_API Bebop_WireResult Bebop_MessageFieldIterator_NextTag(
    Bebop_MessageFieldIterator* iterator, uint8_t* tag, bool* present
);
BEBOP_API Bebop_WireResult Bebop_MessageFieldIterator_Next(
    Bebop_MessageFieldIterator* iterator, uint8_t* tag, Bebop_View* field, bool* present
);

BEBOP_API size_t Bebop_IndexedMessage_EncodedSize(
    size_t payload_size, const uint8_t* sorted_tags, uint8_t field_count
);
BEBOP_API Bebop_WireResult Bebop_Writer_EndIndexedMessage(
    Bebop_Writer* w,

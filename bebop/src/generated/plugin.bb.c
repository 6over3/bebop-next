...
static Bebop_WireResult Bebop_Version__DecodeBody(
...
)
{
  ...
  r = Bebop_Version__DecodeBody(ctx, rd, v);
...
static Bebop_WireResult Bebop_CodeGeneratorRequest__DecodeBody(
...
)
{
  ...
  r = Bebop_CodeGeneratorRequest__DecodeBody(ctx, rd, v);
  Bebop_WireCtx_LeaveDecode(ctx);
  return r;
}
...
static Bebop_WireResult Bebop_Diagnostic__DecodeBody(
...
)
{
  ...
  r = Bebop_Diagnostic__DecodeBody(ctx, rd, v);
  Bebop_WireCtx_LeaveDecode(ctx);
  return r;
}
...
static Bebop_WireResult Bebop_GeneratedFile__DecodeBody(
...
)
{
  ...
  r = Bebop_GeneratedFile__DecodeBody(ctx, rd, v);
  Bebop_WireCtx_LeaveDecode(ctx);
  return r;
}
...
static Bebop_WireResult Bebop_CodeGeneratorResponse__DecodeBody(
    ...
    switch (tag) {
      ...
      case BEBOP_CODE_GENERATOR_RESPONSE_FILES_TAG:
        v->files.has_value = true;
        {
          ...
          Bebop_GeneratedFile* _d0 = Bebop_WireCtx_AllocArray(ctx, _len, sizeof(*_d0));
          if (BEBOP_WIRE_UNLIKELY(!_d0 && _len > 0)) {
            return BEBOP_WIRE_ERR_OOM;
          }
          for (size_t _i0 = 0; _i0 < _len; _i0++) {
      ...
      case BEBOP_CODE_GENERATOR_RESPONSE_DIAGNOSTICS_TAG:
        v->diagnostics.has_value = true;
        {
          ...
          Bebop_Diagnostic* _d0 = Bebop_WireCtx_AllocArray(ctx, _len, sizeof(*_d0));
          if (BEBOP_WIRE_UNLIKELY(!_d0 && _len > 0)) {
            return BEBOP_WIRE_ERR_OOM;
          }
          for (size_t _i0 = 0; _i0 < _len; _i0++) {
...
)
{
  ...
  r = Bebop_CodeGeneratorResponse__DecodeBody(ctx, rd, v);
  Bebop_WireCtx_LeaveDecode(ctx);
  return r;
}
